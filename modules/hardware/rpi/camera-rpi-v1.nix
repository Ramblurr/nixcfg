...
let
  cfg = config.modules.hardware.rpi.camera-rpi-v1;
in

{
  options = {
    modules.hardware.rpi.camera-rpi-v1 = {
      enable = lib.mkEnableOption ''
        support for the Raspberry Pi Camera v1
      '';
  ...
  config = lib.mkIf cfg.enable {
    hardware.deviceTree = {
      ...
      overlays = [
        ...
        #
        # As proposed in https://github.com/NixOS/nixpkgs/issues/125354,
        # the "compatible" attribute is changed to bcm2711.
        {
          name = "ov5647-overlay";
          dtsText = ''
