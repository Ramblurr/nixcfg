# adapted from the nixpkgs package which builds from the official release tarballs
# this version builds from the autobuilt dailies
# ref https://downloads.powerdns.com/
{
  lib,
  stdenv,
  fetchurl,
