-- fetched from https://github.com/bennetthardwick/dotfiles/blob/master/.config/wireplumber/scripts/auto-connect-ports.lua
-- on 2024-01-24
...
function auto_connect_ports(args)
  ...
  function _connect()
    ...
    for output_name, input_name in pairs(args.connect) do
      print("Connecting", output_name, input_name)
