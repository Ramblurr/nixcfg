...
with lib.my;
{
  ...
  nix = {
    ...
    settings = {
      extra-substituters = [ "https://attic.mgmt.${config.repo.secrets.global.domain.home}/REDACTED" ];
      extra-trusted-public-keys = [
        "REDACTED:6DGMWTIQnpp/tsHzx45lX1lUOn4oiDwg7WX1/pJASwE= cache.nixos.org-1:6NCHdD59X431o0gWypbMrAURkbJ16ZPMQFGspcDShjY="
      ];
